    ...
    >
      ...
      <g id="logo_v2_svg__Layer_x0020_1">
        ...
        <g id="logo_v2_svg__Buttons2">
          <circle className="logo_v2_svg__st2" cx={425.2} cy={205.8} r={15.3} />
          <circle className="logo_v2_svg__st2" cx={425.2} cy={258.9} r={15.3} />
          <circle className="logo_v2_svg__st2" cx={398.6} cy={232.4} r={15.3} />
          <circle className="logo_v2_svg__st2" cx={451.7} cy={232.4} r={15.3} />
        </g>
      </g>
    </svg>
  )
