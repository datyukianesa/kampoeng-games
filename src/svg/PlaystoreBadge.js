...
function PlaystoreBadge(props) {
  return (
    ...
    >
      ...
      />
      <path
        d="M5234.4 32.1c93.1 0 169.3 75.7 169.3 168.4v1203c0 92.7-75.7 168.4-169.3 168.4h-5033c-93.1 0-169.3-75.7-169.3-168.4v-1203c0-92.7 75.7-168.4 169.3-168.4h5033zm0-32.1h-5033C90.4 0 0 90.4 0 200.5v1203C0 1514 90.4 1604 201.4 1604h5033c110.9 0 201.4-90 
201.4-200.5v-1203C5435.8 90.4 5345.3 0 5234.4 0z"
        fillRule="evenodd"
        clipRule="evenodd"
        fill="#a6a6a6"
      />
...
74.9-163.5 171.1 0 95.8 78 169.8 163.5 169.8 40.5 0 73.1-18.3 90-38.8h2.7v24.5c0 65.1-34.8 100.2-90.9 100.2-45.9 0-74.4-33-86-60.6l-65.1 27.2c18.7 45 68.6 100.7 151 100.7 87.8 0 162.2-51.7 162.2-177.8V882.2H3191v28.1h-.4zm-86 235.7c-51.7 0-94.9-43.2-94.9-102.9 0-60.2 43.2-103.8 94.9-103.8 51.2 0 90.9 44.1 90.9 103.8.5 59.7-39.6 102.9-90.9 102.9zm977.6-444.2h-179.1V1203h74.9v-189.8h104.3c82.9 0 164.4-60.1 164.4-155.5s-81.2-155.9-164.5-155.9zm2.2 241.4h-106.5v-172h106.5c56.1 0 87.8 46.3 87.8 86 0 39.3-32.1 86-87.8 86zm462.5-71.7c-54.4 0-110.5 24.1-133.7 76.6l66.4 27.6c14.3-27.6 40.5-37 68.2-37 38.8 0 78 23.2 78.9 64.6v5.3c-13.4-7.6-42.8-19.2-78-19.2-71.7 0-144.4 39.2-144.4 112.7 0 67.3 58.8 110.5 124.3 110.5 50.3 0 78-22.7 95.3-49h2.7v38.8h72.2v-192c0-89.4-66.4-138.9-151.9-138.9zm-9.4 274.5c-24.5 0-58.8-12-58.8-42.8 0-38.8 42.8-53.5 79.3-53.5 33 0 48.6 7.1 68.2 16.9-5.4 45-43.4 79-88.7 79.4zm424.7-263.8l-86 217.4h-2.7l-89.1-217.4h-80.6l133.7 303.9-76.2 168.9h78L5045 882.2h-82.8zM4288 1203h74.9V701.8H4288V1203z"
      ...
      <path
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        fill="url(#playstorebadge_svg__a)"
      />
      <linearGradient
        id="playstorebadge_svg__b"
        gradientUnits="userSpaceOnUse"
        x1={1712.662}
        y1={1274.838}
        x2={1606.561}
      ...
      <path
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        fill="url(#playstorebadge_svg__b)"
      />
      <linearGradient
        id="playstorebadge_svg__c"
        gradientUnits="userSpaceOnUse"
        x1={1707.441}
        y1={1290.047}
        x2={1646.682}
      ...
      <path
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        fill="url(#playstorebadge_svg__c)"
      />
      <linearGradient
        id="playstorebadge_svg__d"
        gradientUnits="userSpaceOnUse"
        x1={1660.636}
        y1={1365.668}
        x2={1687.767}
      ...
      <path
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        fill="url(#playstorebadge_svg__d)"
      />
      <path
